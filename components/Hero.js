...
const style = {
  wrapper: `relative`,
  container: `max-w-7xl mx-auto before:content-[''] before:bg-red-500 before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-[url('https://i.ibb.co/ZHvvFBr/istockphoto-157434748.jpg')] before:bg-cover before:bg-center before:opacity-50`,
  contentWrapper: `flex h-screen relative justify-center flex-wrap items-center`,
  copyContainer: ``,
  title: `relative text-white text-[46px] font-semibold md:max-w-[550px] text-center md:text-left`,
  description: `text-[#d9d9d9] container-[400px] text-2xl mt-[0.8rem] mb-[2.5rem] md:max-w-[500px] text-center md:text-left`,
  ctaContainer: `md:flex text-center`,
